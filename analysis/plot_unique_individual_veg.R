...
# 1. Load Data
df <- read.csv("results_500m_inference/individual_veg_drop_results.csv", stringsAsFactors = FALSE)
...
# Ordering & Plotting (using raw_mean for sorting, but sorting is identical for prop_mean since it's just a constant scalar)
...
ggsave("results_500m_inference/figures/figure_unique_individual_veg_raw.png", p_raw, width = 10, height = 7, dpi=300)
ggsave("results_500m_inference/figures/figure_unique_individual_veg_proportional.png", p_prop, width = 10, height = 7, dpi=300)

cat("Successfully generated both raw and proportional unique veg plots.\n")
